! function a(b, c, d) {
    ...
    2: [function(a, b) {
        function c(a, b) {
            e.call(this, a), this.session = b, this.editorView = new f, this.addChild(this.editorView), this.editor = new h(this.session, this.editorView), this.editor.on(h.Refresh, this.onRefresh, this), this.targetView = new g, this.addChild(this.targetView), this.targetView.x = 500, this.target = new i(this.targetView), window.addEventListener("resize", this.onResize.bind(this))
        }
        var d = a("../utils/ClassUtils"),
            e = a("../views/RootView"),
            f = (a("../views/View"), a("../views/EditorControllerView")),
            g = a("../views/TargetControllerView"),
            h = a("../controllers/EditorController"),
            i = a("../controllers/TargetController");
        d.extends(c, e), c.prototype.init = function(a) {
            this.resources = a, a.isLoading() ? (console.log("resources is loading"), a.on(Resources.Loaded, this.doInit, this)) : this.doInit()
        }, c.prototype.addTestcase = function(a, b, c) {
            this.target.addTestcase(a, b, c)
        }, c.prototype.doInit = function() {
            console.log("FiddleClient.prototype.doInit graphics: ", this.resources.getResourceObject().graphics), this.target.init(), this.editor.init(this.resources), this.updateLayout(document.body.clientWidth, document.body.clientHeight)
        }, c.prototype.onRefresh = function() {
            this.target.reload()
        }, c.prototype.onResize = function() {
            console.log("FiddleClient.prototype.onResize"), this.updateLayout(document.body.clientWidth, document.body.clientHeight)
        }, c.prototype.updateLayout = function(a, b) {
            this.editorView.x = 0, this.targetView.x = .5 * a, this.editorView.updateLayout(.5 * a, b), this.targetView.updateLayout(.5 * a, b)
        }, b.exports = c
    }, {
        "../controllers/EditorController": 5,
        "../controllers/TargetController": 10,
        "../utils/ClassUtils": 14,
        "../views/EditorControllerView": 17,
        "../views/RootView": 27,
        "../views/TargetControllerView": 30,
        "../views/View": 32
    }],
    3: [function(a, b) {
        function c(a, b) {
        ...
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./Editor"),
            g = a("../views/ColorItem");
        d.extends(c, f), e.init(c), c.prototype.init = function(a) {
            f.prototype.init.call(this), this.resources = a;
            var b = this.resources.getResourceObject().colors;
            for (var c in b) {
                console.log("create ColorItem: ", c, b[c]);
                var d = new g(c, b[c]);
                this.view.addItem(d), d.on(g.Changed, this.onChanged, this)
            }
        }, c.prototype.onChanged = function(a) {
            this.resources.getResourceObject().colors[a.id] = a.getValue(), this.save()
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "../utils/EventDispatcher": 15,
        "../views/ColorItem": 16,
        "./Editor": 4
    }],
    4: [function(a, b) {
        function c(a, b) {
            this.view = b, this.session = a, this.items = new Array, this.container = null, this.resources = null
        }
        var d = a("../utils/EventDispatcher"),
            e = a("../utils/APIConnection");
        c.prototype.constructor = c, d.init(c), c.Saved = "Saved", c.prototype.init = function() {}, c.prototype.show = function() {
            this.view.show()
        }, c.prototype.hide = function() {
            this.view.hide()
        }, c.prototype.save = function() {
            try {
                var a = new e(this.session);
                a.on("loaded", this.onSaved, this), a.load("save", {
                    session: this.session,
                    json: JSON.stringify(this.resources.getResourceObject())
                })
            } catch (b) {
                console.log("Failed to save: ", b)
            }
        }, c.prototype.onSaved = function(a) {
            {
                var b = a.connection;
                a.json
            }
            b.off("loaded", this.onSaved, this), this.trigger(c.Saved)
        }, b.exports = c
    }, {
        "../utils/APIConnection": 13,
        "../utils/EventDispatcher": 15
    }],
    5: [function(a, b) {
        function c(a, b) {
            this.view = b, this.view.show(), this.menuView = new m, this.view.setMenuView(this.menuView);
            var c = [new l("image", "Graphics"), new l("position", "Positions"), new l("color", "Colors"), new l("string", "Strings")];
            this.menuView.setItems(c), this.menu = new k(this.menuView, c), this.menu.on(k.ItemClicked, this.onChangeView, this);
            var d = new e;
            this.view.addEditor(d), d.y = this.menuView.height, this.graphicsEditor = new g(a, d);
            var d = new e;
            this.view.addEditor(d), d.y = this.menuView.height, this.positionsEditor = new h(a, d);
            var d = new e;
            this.view.addEditor(d), d.y = this.menuView.height, this.colorsEditor = new j(a, d);
            var d = new e;
            this.view.addEditor(d), this.stringsEditor = new i(a, d), this.currentEditor = this.graphicsEditor, this.currentEditor.show(), this.graphicsEditor.on("uploaded", this.onUploaded, this), this.graphicsEditor.on(f.Saved, this.onSaved, this), this.positionsEditor.on(f.Saved, this.onSaved, this), this.colorsEditor.on(f.Saved, this.onSaved, this), this.stringsEditor.on(f.Saved, this.onSaved, this)
        }
        var d = a("../utils/EventDispatcher"),
            e = a("../views/EditorView"),
            f = a("../controllers/Editor"),
            g = a("../controllers/GraphicsEditor"),
            h = a("../controllers/PositionsEditor"),
            i = a("../controllers/StringsEditor"),
            j = a("../controllers/ColorsEditor"),
            k = a("../controllers/Menu"),
            l = a("../views/MenuItem"),
            m = a("../views/MenuView");
        c.prototype.constructor = c, d.init(c), c.Refresh = "refresh", c.prototype.init = function(a) {
            this.resources = a, this.positionsEditor.init(a), this.graphicsEditor.init(a), this.colorsEditor.init(a), this.graphicsEditor.save()
        }, c.prototype.onChangeView = function(a) {
            switch (this.currentEditor.hide(), a.id) {
                case "image":
            ...
            this.currentEditor.show(), this.currentEditor.view.updateLayout(this.view.width, this.view.height), setTimeout(function() {
                this.view.updateLayout(.5 * document.body.clientWidth, document.body.clientHeight)
            }.bind(this), 0)
        }, c.prototype.onUploaded = function() {
            this.trigger(c.Refresh)
        }, c.prototype.onSaved = function() {
            this.trigger(c.Refresh)
        }, b.exports = c
    }, {
        "../controllers/ColorsEditor": 3,
        "../controllers/Editor": 4,
        "../controllers/GraphicsEditor": 6,
        "../controllers/Menu": 7,
        "../controllers/PositionsEditor": 8,
        "../controllers/StringsEditor": 9,
        "../utils/EventDispatcher": 15,
        "../views/EditorView": 18,
        "../views/MenuItem": 24,
        "../views/MenuView": 25
    ...
    6: [function(a, b) {
        function c(a, b) {
            g.call(this, a, b), this.currentItem = null
        } {
            var d = a("../utils/ClassUtils"),
                e = a("../utils/EventDispatcher"),
                f = a("../utils/APIConnection"),
                g = a("./Editor"),
                h = a("../views/ImageItem");
            a("../views/SelectButton"), a("../../../lib/Resources")
        }
        d.extends(c, g), e.init(c), c.prototype.init = function(a) {
            g.prototype.init.call(this), this.resources = a;
            var b = this.resources.getResourceObject().graphics;
            console.log("graphics: ", b);
            for (var c in b)
                if ("textures" != c) {
                    console.log("create ImageItem: ", c, b[c]);
                    var d = new h(c, this.resources.getDOMTexture(c));
                    this.view.addItem(d), d.on(h.Selected, this.onUpload, this)
                }
        }, c.prototype.onUpload = function(a) {
            if (a.getValues().length > 0) {
                var b = new FormData;
                b.append("SelectedFile", a.getValues()[0]), b.append("Filename", a.name), b.append("url", document.location), this.currentItem = a;
                var c = new f(this.session);
                c.on("loaded", this.onUploaded, this), c.upload("upload", b)
            } else console.warn("No files selected: event:", a)
        }, c.prototype.onUploaded = function(a) {
            var b = (a.connection, a.json);
            console.log("GraphicsEditor.prototype.onUploaded: json = ", JSON.stringify(b)), this.resources.addSource({
                graphics: b
            }), this.save(), this.currentItem.setTexture(this.resources.getDOMTexture(this.currentItem.name)), this.trigger("uploaded", b)
        }, b.exports = c
    }, {
        "../../../lib/Resources": 33,
        "../utils/APIConnection": 13,
        ...
        "../utils/EventDispatcher": 15,
        "../views/ImageItem": 20,
        "../views/SelectButton": 28,
        "./Editor": 4
    }],
    7: [function(a, b) {
        function c(a, b) {
            this.menuItems = b, this.view = a;
            for (var c = 0; c < this.menuItems.length; c++) this.menuItems[c].on(e.Click, this.onMenuItemClick, this);
            this.menuItems.length > 0 && (this.currentMenuItem = this.menuItems[0], this.currentMenuItem.setSelected(!0))
        }
        var d = a("../utils/EventDispatcher"),
            e = a("../views/MenuItem");
        c.prototype.constructor = c, d.init(c), c.ItemClicked = "ItemClicked", c.prototype.addItem = function(a) {
            this.menuItems.length <= 0 && (this.currentMenuItem = a, this.currentMenuItem.setSelected(!0), this.trigger(c.ItemClicked, a)), this.view.addItem(a), a.on(e.Click, this.onMenuItemClick, this)
        }, c.prototype.onMenuItemClick = function(a) {
            this.currentMenuItem.setSelected(!1), this.currentMenuItem = a, this.currentMenuItem.setSelected(!0), this.trigger(c.ItemClicked, a)
        }, b.exports = c
    }, {
        "../utils/EventDispatcher": 15,
        "../views/MenuItem": 24
    ...
    8: [function(a, b) {
        ...
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./Editor"),
            g = a("../views/PositionItem");
        d.extends(c, f), e.init(c), c.prototype.init = function(a) {
            f.prototype.init.call(this), this.resources = a;
            var b = this.resources.getResourceObject().positions;
            console.log("positions: ", b);
            for (var c in b) {
                console.log("create PositionItem: ", c, b[c]);
                var d = new g(c, b[c]);
                this.view.addItem(d), d.on(g.Changed, this.onChanged, this)
            }
        }, c.prototype.onChanged = function(a) {
            this.resources.getResourceObject().positions[a.id][0] = a.getValues()[0], this.resources.getResourceObject().positions[a.id][1] = a.getValues()[1], this.save()
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "../utils/EventDispatcher": 15,
        "../views/PositionItem": 26,
        "./Editor": 4
    }],
    9: [function(a, b) {
        function c(a, b) {
        ...
        var d = a("../utils/ClassUtils"),
            e = a("./Editor"),
            f = a("../views/StringItem");
        d.extends(c, e), c.prototype.init = function(a) {
            e.prototype.init.call(this), this.resources = a;
            var b = this.resources.getResourceObject().strings;
            for (var c in b) {
                var d = new f(c, b[c]);
                this.view.addItem(d), d.on(f.Changed, this.onChanged, this)
            }
        }, c.prototype.onChanged = function(a) {
            this.resources.strings[a.id] = a.getValue()
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "../views/StringItem": 29,
    ...
    10: [function(a, b) {
        function c(a) {
            this.view = a, this.menuView = new g, this.view.setMenuView(this.menuView);
            var b = [];
            this.testcases = new Array, this.menuView.setItems(b), this.menu = new e(this.menuView, b), this.menu.on(e.ItemClicked, this.onChangeView, this), this.iframeView = new h, this.view.setTargetView(this.iframeView), this.iframeView.y = this.menuView.height, this.iframeView.width = 500, this.iframeView.height = 500
        }
        var d = a("../utils/EventDispatcher"),
            e = a("../controllers/Menu"),
            f = a("../views/MenuItem"),
            g = a("../views/MenuView"),
            h = a("../views/IFrameView"),
            i = a("../models/Testcase");
        c.prototype.constructor = c, d.init(c), c.prototype.init = function() {
            this.iframeView.init()
        }, c.prototype.addTestcase = function(a, b, c) {
            this.testcases.push(new i(a, b, c)), this.menu.addItem(new f(a, b))
        }, c.prototype.reload = function() {
            this.iframeView.reload()
        }, c.prototype.onChangeView = function(a) {
            for (var b = 0; b < this.testcases.length; b++)
                if (this.testcases[b].id == a.id) return this.targetURL = this.testcases[b].url, void this.iframeView.setUrl(this.targetURL)
        }, b.exports = c
    }, {
        "../controllers/Menu": 7,
        "../models/Testcase": 12,
    ...
    11: [function(a) {
        FiddleClient = a("./app/FiddleClient"), Resources = a("../../lib/Resources")
    }, {
        "../../lib/Resources": 33,
        "./app/FiddleClient": 2
    }],
    12: [function(a, b) {
        function c(a, b, c) {
            this.id = a, this.name = b, this.url = c
        }
        b.exports = c
    }, {}],
    13: [function(a, b) {
        function c(a) {
            this.url = "php/?__route__=/", this.session = a
        }
        var d = a("./EventDispatcher");
        d.init(c), c.prototype.load = function(a, b) {
            var c = null;
            c = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), c.onreadystatechange = this.onReadyStateChange.bind(this, c);
            var d = this.url + a,
                e = "",
                f = !0;
            for (var g in b) f ? f = !1 : e += "&", e += g + "=" + b[g];
            e += "&session=" + this.session, e += "&___timestamp____=" + Date.now(), c.open("POST", d, !0), c.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), c.send(e)
        }, c.prototype.upload = function(a, b) {
            var c = null;
            c = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), c.onreadystatechange = this.onReadyStateChange.bind(this, c);
            var d = this.url + a + "&session=" + this.session;
            c.open("POST", d, !0), c.send(b)
        }, c.prototype.onReadyStateChange = function(a) {
            if (4 == a.readyState)
                if (200 == a.status || -1 == window.location.href.indexOf("http")) {
                    var b = JSON.parse(a.response);
                    this.trigger("loaded", {
                        connection: this,
                        json: b
                    })
                } else console.log("An error has occured making the request")
        }, b.exports = c
    }, {
        "./EventDispatcher": 15
    }],
    ...
    15: [function(a, b) {
        ...
        c.prototype.addEventListener = function(a, b, c) {
            if (this.listenerMap || (this.listenerMap = {}), !a) throw new Error("Event type required for event dispatcher");
            if (!b) throw new Error("Listener required for event dispatcher");
            this.removeEventListener(a, b, c), this.listenerMap.hasOwnProperty(a) || (this.listenerMap[a] = []), this.listenerMap[a].push({
                listener: b,
                scope: c
            })
        }, c.prototype.removeEventListener = function(a, b, c) {
            if (this.listenerMap || (this.listenerMap = {}), this.listenerMap.hasOwnProperty(a)) {
                for (var d = this.listenerMap[a], e = 0; e < d.length; e++) {
                    var f = d[e];
                    b == f.listener && c == f.scope && (d.splice(e, 1), e--)
                }
                d.length || delete this.listenerMap[a]
            }
        }, c.prototype.dispatchEvent = function(a, b) {
            if (this.listenerMap || (this.listenerMap = {}), "string" == typeof a && (a = {
                    type: a
                }), this.listenerMap.hasOwnProperty(a.type)) {
                void 0 == b && (b = a);
                for (var c in this.listenerMap[a.type]) {
                    var d = this.listenerMap[a.type][c];
                    d.listener.call(d.scope, b)
                }
            }
        }, c.prototype.on = c.prototype.addEventListener, c.prototype.off = c.prototype.removeEventListener, c.prototype.trigger = c.prototype.dispatchEvent, c.init = function(a) {
            a.prototype.addEventListener = c.prototype.addEventListener, a.prototype.removeEventListener = c.prototype.removeEventListener, a.prototype.dispatchEvent = c.prototype.dispatchEvent, a.prototype.on = c.prototype.on, a.prototype.off = c.prototype.off, a.prototype.trigger = c.prototype.trigger
        }, b.exports = c
    }, {}],
    16: [function(a, b) {
        function c(a, b) {
            f.call(this, a), this.id = a, this.colorView = new h(h.Div, "color-view"), this.addChild(this.colorView), this.colorView.width = 100, this.colorView.height = 100, this.colorView.background = b ? b : "#000000", this.colorView.y = this.header.height, this.input = new g, this.addChild(this.input), this.input.setValue(b ? b : "#000000"), this.input.x = this.colorView.width, this.input.y = this.colorView.y + .5 * (this.colorView.height - this.input.height), this.input.addEventListener(g.Changed, this.onChanged, this)
        }
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./ListItem"),
            g = a("./InputView"),
            h = a("./View");
        d.extends(c, f), e.init(c), c.Changed = "Changed", c.prototype.updateLayout = function(a, b) {
            f.prototype.updateLayout.call(this, a, b), this.colorView.width = .5 * a, this.colorView.height = b - this.header.height, this.input.updateLayout(.5 * a, b - this.header.height), this.input.x = .5 * a, this.input.y = this.header.height, this.colorView.y = this.header.height
        }, c.prototype.onChanged = function() {
            this.trigger(c.Changed, this)
    ...
    17: [function(a, b) {
        function c() {
            e.call(this, e.Div, "EditorControllerView"), this.menuView = null, this.editors = new Array
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.setMenuView = function(a) {
            this.menuView = a, this.addChild(this.menuView)
        }, c.prototype.addEditor = function(a) {
            this.editors.push(a), this.addChild(a)
        }, c.prototype.updateLayout = function(a, b) {
            this.menuView.updateLayout(a, this.menuView.height);
            for (var c = 0; c < this.editors.length; c++) this.editors[c].x = 0, this.editors[c].y = this.menuView.height, this.editors[c].isVisible() && this.editors[c].updateLayout(a, b - this.menuView.height);
            this.width = a, this.height = b
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
    ...
    18: [function(a, b) {
        function c() {
            e.call(this, e.Div, "EditorView"), this.items = new Array, this.hide()
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.addItem = function(a) {
            this.items.push(a), this.addChild(a)
        }, c.prototype.updateLayout = function(a, b) {
            for (var c = 0, d = 0; d < this.items.length; d++) this.items[d].y = c, this.items[d].updateLayout(a, 130), c += 130;
            this.width = a, this.height = b
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
    ...
    19: [function(a, b) {
        function c() {
            e.call(this, e.IFrame, "IFrameView"), this.getElement().style.width = "100%", this.getElement().style.height = "100%", this.url = ""
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.init = function() {}, c.prototype.setUrl = function(a) {
            this.url = a, this.reload()
        }, c.prototype.reload = function() {
    ...
    20: [function(a, b) {
        function c(a, b) {
            f.call(this, a), this.name = a, this.image = new h(b), this.addChild(this.image), this.image.y = this.header.height, this.button = new g("Upload new image"), this.addChild(this.button), this.button.on(g.Change, this.onFilesSelected, this)
        } {
            var d = a("../utils/ClassUtils"),
                e = a("../utils/EventDispatcher"),
                f = a("./ListItem"),
        ...
        d.extends(c, f), e.init(c), c.Selected = "Selected", c.prototype.setTexture = function(a) {
            this.image.setTexture(a)
        }, c.prototype.updateLayout = function(a, b) {
            f.prototype.updateLayout.call(this, a, b), this.image.updateLayout(.5 * a, b - this.header.height), this.image.y = this.header.height, this.button.y = this.header.height + .5 * (b - this.header.height - this.button.height), this.button.x = .5 * a
        }, c.prototype.onFilesSelected = function(a) {
            this.files = a, this.trigger(c.Selected, this)
    ...
    21: [function(a, b) {
        function c(a) {
            e.call(this, e.Div, "ImageView"), this.imageObject = null, this.noImage = null, null != a ? (this.getElement().appendChild(a), this.imageObject = a) : (this.imageObject = new Image, this.imageObject.src = "img/no_image.jpeg", this.getElement().appendChild(this.imageObject))
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.setTexture = function(a) {
            this.getElement().removeChild(this.imageObject), this.imageObject = a, this.getElement().appendChild(a), this.updateLayout(this.w, this.h)
        }, c.prototype.updateLayout = function(a, b) {
            this.w = a, this.h = b;
            var c = 0 == this.imageObject.clientWidth ? this.imageObject.width : this.imageObject.clientWidth,
                d = 0 == this.imageObject.clientHeight ? this.imageObject.height : this.imageObject.clientHeight;
            if (0 == c || 0 == d) return void(this.imageObject.onload = this.updateLayout.bind(this, a, b));
            var e = 0,
                f = 0;
            if (c > a && (e = Math.abs(a - c)), d > b && (f = Math.abs(b - d)), 0 == f && 0 == e) return this.imageObject.style.position = "absolute", this.imageObject.style.left = .5 * (a - c) + "px", void(this.imageObject.style.top = .5 * (b - d) + "px");
            var g = 1;
            g = b / d, g * c > a && (g = a / c), this.imageObject.style.msTransform = "scale(" + g + ")", this.imageObject.style.transform = "scale(" + g + ")", this.imageObject.style.webkitTransform = "scale(" + g + ")", this.imageObject.style.position = "absolute", this.imageObject.style.left = .5 * (a - c) + "px", this.imageObject.style.top = .5 * (b - d) + "px", this.width = a, this.height = b
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "./View": 32
    ...
    22: [function(a, b) {
        function c() {
            f.call(this, f.Input, "InputView"), this.getElement().setAttribute("type", "text"), this.getElement().addEventListener("blur", this.onBlur.bind(this))
        }
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./View");
        d.extends(c, f), e.init(c), c.Changed = "Changed", c.prototype.getValue = function() {
    ...
    23: [function(a, b) {
        function c(a) {
            e.call(this, e.Div, "ListItem"), this.header = new e, this.addChild(this.header), this.header.background = "#AAAAAA", this.headerText = new f(a), this.header.addChild(this.headerText)
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View"),
            f = a("./Text");
        d.extends(c, e), c.prototype.updateLayout = function(a, b) {
            this.headerText.width = a, this.headerText.height = 30, this.header.width = a, this.header.height = 30, this.width = a, this.height = b
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "./Text": 31,
    ...
    24: [function(a, b) {
        function c(a, b) {
            f.call(this, f.Div, "MenuItem"), this.getElement().addEventListener("click", this.onClick.bind(this)), this.id = a, this.string = b, this.text = new g(this.string), this.addChild(this.text), this.setSelected(!1)
        }
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./View"),
            g = a("./Text");
        d.extends(c, f), e.init(c), c.Click = "Click", c.prototype.onClick = function() {
            this.trigger(c.Click, this)
        }, c.prototype.setSelected = function(a) {
            this.selected = a, this.selected ? (this.background = "#FF0000", this.text.color = "#0000FF") : (this.background = "#000000", this.text.color = "#FFFFFF")
        }, c.prototype.updateLayout = function(a, b) {
            this.text.updateLayout(a, b)
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "../utils/EventDispatcher": 15,
    ...
    25: [function(a, b) {
        function c() {
            e.call(this, e.Div, "MenuView"), this.height = 100, this.items = []
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.setItems = function(a) {
            for (var b = 0, c = 0; c < a.length; c++) {
                var d = a[c];
                this.addChild(d), d.x = b, b += d.width
            }
            this.items = a
        }, c.prototype.addItem = function(a) {
            for (var b = 0, c = 0; c < this.items.length; c++) this.items[c].x = b, b += this.items[c].width;
            this.addChild(a), a.x = b, this.items.push(a)
        }, c.prototype.updateLayout = function(a, b) {
            for (var c = 0, d = 0; d < this.items.length; d++) {
                var e = this.items[d];
                e.x = c, e.updateLayout(a / this.items.length, b), c += e.width
            }
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
    ...
    27: [function(a, b) {
        function c(a) {
            e.call(this, e.div, "RootView"), this.isRoot = !0, a.appendChild(this.getElement())
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "./View": 32
    }],
    28: [function(a, b) {
        function c(a) {
            f.call(this, f.Input, "SelectButton"), this.getElement().setAttribute("type", "file"), this.getElement().setAttribute("value", a), this.getElement().setAttribute("accept", "image/*"), this.getElement().addEventListener("change", this.onChange.bind(this)), this.width = 80, this.height = 30
        }
        var d = a("../utils/ClassUtils"),
            e = a("../utils/EventDispatcher"),
            f = a("./View");
        d.extends(c, f), e.init(c), c.Change = "change", c.prototype.onChange = function() {
            this.trigger(c.Change, this.getElement().files)
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "../utils/EventDispatcher": 15,
    ...
    29: [function(a, b) {
        function c(a, b) {
            f.call(this, a), b && "" != b && console.log("Image item frame seems to exist"), this.name = name, this.text = new h, this.input = new i, this.addChild(this.text), this.addChild(this.input), this.text.width = 100, this.input.width = 200, this.text.y = this.header.height, this.input.y = this.header.height, this.input.x = 100, this.button.on(g.Change, this.onFilesSelected, this)
        } {
            var d = a("../utils/ClassUtils"),
                e = a("../utils/EventDispatcher"),
                f = a("./ListItem"),
        ...
        d.extends(c, f), e.init(c), c.Changed = "Changed", c.prototype.updateLayout = function(a, b) {
            f.prototype.updateLayout.call(this, a, b), this.text.updateLayout(.5 * a, b - this.header.height), this.input.updateLayout(.5 * a, b - this.header.height), this.text.x = 0, this.input.x = .5 * a, this.text.y = this.header.height, this.input.y = this.header.height
        }, c.prototype.onChanged = function() {
            this.trigger(c.Changed, this)
        }, b.exports = c
    }, {
    ...
    30: [function(a, b) {
        function c() {
            e.call(this, e.Div, "TargetControllerView"), this.menuView = null, this.targetView = null
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.setMenuView = function(a) {
            this.menuView = a, this.addChild(this.menuView)
        }, c.prototype.setTargetView = function(a) {
            this.targetView = a, this.addChild(a)
        }, c.prototype.updateLayout = function(a, b) {
            this.menuView.updateLayout(a, this.menuView.height), this.targetView.x = 0, this.targetView.y = this.menuView.height, this.targetView.updateLayout(a, b - this.menuView.height)
        }, b.exports = c
    }, {
        "../utils/ClassUtils": 14,
        "./View": 32
    ...
    31: [function(a, b) {
        function c(a) {
            e.call(this, e.Span, "Text"), this.getElement().innerHTML = a, this.getElement().style.textAlign = "center"
        }
        var d = a("../utils/ClassUtils"),
            e = a("./View");
        d.extends(c, e), c.prototype.updateLayout = function(a, b) {
    ...
    32: [function(a, b) {
        function c(a, b) {
            this._domElement = document.createElement(a ? a : c.Div), this._frame = {
                x: 0,
                y: 0,
                width: 0,
                height: 0
            }, this._domElement.style.position = "absolute", this.isRoot = !1, this._domElement.className = b ? b : "View", this.parent = null, this.children = new Array
        }
        c.prototype.constructor = c, c.Image = "img", c.Input = "input", c.Div = "div", c.Span = "span", c.IFrame = "iframe", c.prototype.getElement = function() {
            return this._domElement
        }, c.prototype.isOnStage = function() {
            return null != this.parent ? this.parent.isOnStage() : 1 == this.isRoot ? !0 : !1
        }, c.prototype.addChild = function(a) {
            if (a.parent = this, this.children.push(a), this._domElement.appendChild(a._domElement), 1 == this.isOnStage()) {
                {
                    a.height + a.width
                }
                a.addedToStage()
            }
        }, c.prototype.addedToStage = function() {
            for (var a = 0; a < this.children.length; a++) this.children[a].addedToStage()
        }, c.prototype.removeChild = function(a) {
            var b = this.children.indexOf(a);
            if (-1 == b) throw new Error("Trying to remove an element that wasn't a child");
            a.parent = null, this._domElement.removeChild(a._domElement), this.children.splice(b, 1)
        }, c.prototype.show = function() {
            this._domElement.style.display = "inline-block"
        }, c.prototype.hide = function() {
            this._domElement.style.display = "none"
        }, c.prototype.isVisible = function() {
            return "none" != this._domElement.style.display
        }, c.prototype.updateLayout = function() {
            ...
            set: function(a) {
                this._frame.x = a, this._domElement.style.left = a + "px"
            }
            ...
            set: function(a) {
                this._frame.y = a, this._domElement.style.top = a + "px"
            }
        }), Object.defineProperty(c.prototype, "width", {
            get: function() {
                var a = this._frame.width;
                this.width = this._domElement.clientWidth;
                for (var b = 0; b < this.children.length; b++) {
                    var c = this.children[b];
                    c.x + c.width > a && (a = c.x + c.width)
                }
                return a > this._domElement.clientWidth && (this.width = a), a
            },
            set: function(a) {
                this.isOnStage() && ("string" == typeof a ? (console.log("width is string: ", a), this._domElement.style.width = a) : this._domElement.style.width = a + "px"), this._frame.width = a
            }
        }), Object.defineProperty(c.prototype, "height", {
            get: function() {
                var a = this._frame.height;
                this.height = this._domElement.clientHeight;
                for (var b = 0; b < this.children.length; b++) {
                    var c = this.children[b];
                    c.y + c.height > a && (a = c.y + c.height)
                }
                return a > this._domElement.clientHeight && (this.height = a), a
            },
            set: function(a) {
                this.isOnStage() && ("string" == typeof a ? (console.log("height is string: ", a), this._domElement.style.height = a) : this._domElement.style.height = a + "px"), this._frame.height = a
            }
        }), Object.defineProperty(c.prototype, "background", {
            get: function() {
                return this._domElement.style.background
            },
            set: function(a) {
                this._domElement.style.background = a
            }
    ...
    33: [function(a, b) {
        function c() {
            this.resources = {
                ...
                strings: {},
                values: {}
            }, this.sources = new Array, this.Align = {
                Left: "left",
                Right: "right",
                Center: "center"
            }, this.textures = {}, this.loadCount = 0, this.loadIndex = 0, this.texturesLoaded = 0, this.textureCount = 0
        }
        var d = a("pixi.js"),
            e = a("../client/js/utils/EventDispatcher");
        e.init(c), c.Loaded = "loaded", c.prototype.isLoading = function() {
            return this.loadCount > 0 || this.texturesLoaded < this.textureCount
        }, c.prototype.addSource = function(a) {
            function b(a) {
                if (a) {
                    var b = new XMLHttpRequest;
                    return b.open("GET", a, !1), b.send(), 200 == b.status
                }
                return !1
            }
            if (console.log("Resources.prototype.addSource  (typeof object) = ", typeof a), "string" == typeof a) {
                try {
                    if (!b(a)) return void console.warn("File didn't exist: ", a)
                } catch (c) {
                    console.warn("Failed to load file: ", a)
                }
                try {
                    var e = new d.JsonLoader(a, !0);
                    e.onLoaded = this.onLoaded.bind(this, e, this.loadIndex);
                    var f = parseInt(this.loadIndex + 0);
                    e.onError = this.onError.bind(this, e, f), e.load(), this.sources.push(this.loadIndex), this.loadCount++, this.loadIndex++
                } catch (c) {
                    console.warn("Failed to load file: ", a)
                }
            } else this.loadCount <= 0 ? (this.loadCount++, this.onLoaded({
                json: a
            }, this.loadIndex), this.loadIndex++) : (this.sources.push(a), this.loadIndex++)
        }, c.prototype.getResourceObject = function() {
            return this.resources
        }, c.prototype.onLoaded = function(a, b) {
            if (this.loadCount--, null != a && (this.sources[b] = a.json), this.loadCount <= 0) {
                for (var e = 0; e < this.sources.length; e++)
                    for (var f in this.sources[e])
                        for (var g in this.sources[e][f]) this.resources[f][g] = this.sources[e][f][g];
                if (this.resources.graphics.textures) {
                    this.textureCount = this.resources.graphics.textures.length;
                    for (var e = 0; e < this.resources.graphics.textures.length; e++) {
                        var h = this.resources.graphics.textures[e];
                        this.textures[h.id] = new d.Texture.fromImage(h.file), this.textures[h.id].baseTexture.hasLoaded ? this.onTextureLoaded() : (this.textures[h.id].baseTexture.addEventListener("loaded", this.onTextureLoaded.bind(this)), this.textures[h.id].baseTexture.addEventListener("error", this.onTextureError.bind(this)))
                    }
                } else this.trigger(c.Loaded)
            }
        }, c.prototype.onError = function() {
            if (console.warn("Resources.prototype.onError"), this.loadCount--, this.loadCount <= 0) {
                for (var a = 0; a < this.sources.length; a++)
                    for (var b in this.sources[a]) this.resources[b] = this.sources[a][b];
                if (this.resources.graphics.textures) {
                    this.textureCount = this.resources.graphics.textures.length;
                    for (var a = 0; a < this.resources.graphics.textures.length; a++) {
                        var e = this.resources.graphics.textures[a];
                        this.textures[e.id] = new d.Texture.fromImage(e.file), this.textures[e.id].baseTexture.hasLoaded ? this.onTextureLoaded() : (this.textures[e.id].baseTexture.addEventListener("loaded", this.onTextureLoaded.bind(this)), this.textures[e.id].baseTexture.addEventListener("error", this.onTextureError.bind(this)))
                    }
                } else this.trigger(c.Loaded)
            }
        }, c.prototype.onTextureLoaded = function() {
            console.warn("Resources.prototype.onTextureLoaded"), this.texturesLoaded++, this.texturesLoaded >= this.textureCount && this.trigger(c.Loaded)
        }, c.prototype.onTextureError = function() {
            console.warn("Resources.prototype.onTextureError"), this.texturesLoaded++, this.texturesLoaded >= this.textureCount && this.trigger(c.Loaded)
        }, c.prototype.getValue = function(a) {
            var b = this.resources.values[a];
            if (null == b) throw new Error("Invalid skin key: " + a);
            return b
        }, c.prototype.getColor = function(a) {
            var b = null;
            if (null != this.resources && null != this.resources.colors[a] && (b = this.resources.colors[a]), null == b) throw new Error("Invalid skin key: " + a);
            return b
        }, c.prototype.getPoint = function(a) {
            var b = null;
            if (null != this.resources && null != this.resources.positions[a] && (b = new d.Point(this.resources.positions[a][0], this.resources.positions[a][1])), null == b) throw new Error("Invalid skin key: " + a);
            return b
        }, c.prototype.getTexture = function(a) {
            var b = null,
                c = null,
                d = null;
            if (null != this.resources && null != this.resources.graphics[a] && (b = this.resources.graphics[a]), null == b) throw new Error("Missing key: " + a);
            if (null != b.texture && (c = b.texture), null != b.coords && (d = b.coords), null != c) return null != d ? this.getComponentsPart(c, d[0], d[1], d[2], d[3]) : this.getComponentsPart(c, d);
            throw new Error("Invalid key: " + a)
        }, c.prototype.getDOMTexture = function(a) {
            var b = null,
                c = null,
                d = null;
            return null != this.resources && null != this.resources.graphics[a] && (b = this.resources.graphics[a]), null != b.texture && (c = b.texture), null != b.coords && (d = b.coords), null != c ? null != d ? this.getDOMComponentsPart(c, d[0], d[1], d[2], d[3]) : this.getDOMComponentsPart(c, d) : (console.warn("Invalid key: " + a), null)
        }, c.prototype.getComponentsPart = function(a, b, c, e, f) {
            var g, h = this.getTextureFromSkin(a);
            return g = null === b ? {
                x: 0,
                y: 0,
                width: h.width,
        ...
        }, c.prototype.getDOMComponentsPart = function(a, b, c, d, e) {
            var f = this.getComponentsPart(a, b, c, d, e),
                g = f.baseTexture.source.cloneNode(),
                h = document.createElement("div");
            return h.appendChild(g), g.style.position = "relative", g.style.left = "-" + b + "px", g.style.top = "-" + c + "px", h.style.overflow = "hidden", h.style.width = d + "px", h.style.height = e + "px", h
        }, c.prototype.getTextureFromSkin = function(a) {
            var b = null;
            if (null != this.resources && null != this.resources.graphics.textures)
                for (var c = 0; c < this.resources.graphics.textures.length; c++) this.resources.graphics.textures[c].id == a && (b = this.resources.graphics.textures[c]);
            if (null == b) throw new Error("textureid doesn't exist: " + a);
            return null == this.textures[b.id] && (this.textures[b.id] = new d.Texture.fromImage(b.file)), this.textures[b.id]
        }, b.exports = c
    }, {
        "../client/js/utils/EventDispatcher": 15,
        "pixi.js": 1
    }]
}, {}, [11]);